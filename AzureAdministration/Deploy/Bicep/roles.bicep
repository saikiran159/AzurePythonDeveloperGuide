...
param principalId string // required parameter, and principal (user, group, device, service principal)

@description('roleDefinition for the assignment - default is contributor')
param roleDefinitionId string = 'b24988ac-6180-42a0-ab88-20f7382dd24c' // optional param, role id
